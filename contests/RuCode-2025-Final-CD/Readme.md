...
Ниже — готовый раздел для задачи D в стиле текущего разборника, а вставлять его нужно в двух местах: добавить пункт в раздел «Содержание» между пунктами C и E, и сам раздел поместить сразу после секции «### C. …» и разделителя "***", перед секцией «### E. …» в Readme.md.[1]

### Что и куда вставить
- В «Содержание» вставить строку: "- D — максимум суммы OR/AND по нулям и единицам" сразу после пункта про задачу C и перед пунктом про задачу E.[1]
- Текст раздела «### D. Максимум суммы OR/AND по нулям и единицам» вставить в теле файла после блока задачи C и следующего за ним разделителя "***", то есть непосредственно перед началом секции E.[1]
