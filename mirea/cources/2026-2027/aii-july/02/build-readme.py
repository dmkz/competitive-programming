...
TITLE = "# Лекция 2. Stack, queue, deque и линейная обработка последовательностей"
PART_DIRS = [
    "Part-01-Linear-structures",
    "Part-02-Stack-patterns",
    "Part-03-Min-queue",
    "Part-04-Monostack",
]
NOTICE = """<!-- Этот файл собран автоматически из README.md внутри Part-01-Linear-structures, Part-02-Stack-patterns, Part-03-Min-queue и Part-04-Monostack. -->
