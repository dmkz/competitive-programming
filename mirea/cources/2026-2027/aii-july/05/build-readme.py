...
TITLE = "# Лекция 5. Два указателя и скользящее окно"
PART_DIRS = [
    "Part-01-Sliding-window",
    "Part-02-Binary-search-and-window",
    "Part-03-Two-pointers-on-subarrays",
    "Part-04-Sorted-two-pointers-and-checklist",
]
NOTICE = """<!-- Этот файл собран автоматически из README.md внутри Part-01-Sliding-window, Part-02-Binary-search-and-window, Part-03-Two-pointers-on-subarrays и Part-04-Sorted-two-pointers-and-checklist. -->
