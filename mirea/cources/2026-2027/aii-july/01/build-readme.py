...
PART_DIRS = [
    "Part-01-Arrays-and-lists",
    "Part-02-Processing",
    "Part-03-Sorting",
    "Part-04-Binary-search",
]
NOTICE = """<!-- Этот файл собран автоматически из README.md внутри Part-01-Arrays-and-lists, Part-02-Processing, Part-03-Sorting и Part-04-Binary-search. -->
