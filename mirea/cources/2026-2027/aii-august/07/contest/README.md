...
<p align="center">
  <img src="pictures/e-square-free-core.svg" alt="Получение квадратно-свободной части чисел 12 и 75" width="950">
</p>
<p align="center">
  <em>Рисунок 1. При построении квадратно-свободной части множители с чётными степенями удаляются, а множители с нечётными степенями сохраняются. У чисел 12 и 75 остаётся одна и та же характеристика 3, поэтому в их произведении степени всех простых множителей становятся чётными.</em>
</p>
...
<p align="center">
  <img src="pictures/e-count-pairs-and-zeros.svg" alt="Подсчёт пар с одинаковой квадратно-свободной частью и обработка нулей" width="950">
</p>
<p align="center">
  <em>Рисунок 2. Для текущего ненулевого элемента добавляются все ранее встреченные элементы с такой же квадратно-свободной частью и все предыдущие нули. Если текущий элемент равен нулю, он образует пару с каждым из i предыдущих элементов. Каждая пара учитывается при обработке своего правого конца.</em>
</p>
...
<p align="center">
  <img src="pictures/e-factorization-easy-hard.svg" alt="Различие факторизации в простой и сложной версиях задачи" width="950">
</p>
<p align="center">
  <em>Рисунок 3. В простой версии при факторизации перебираются все возможные делители до квадратного корня. В сложной версии заранее строится список простых чисел, поэтому для каждого элемента проверяются только простые делители. Способ построения квадратно-свободной части при этом не меняется.</em>
</p>
