...
$$R^2(\cos^2t+\sin^2t)=R^2$$

Таким образом, при любом значении $t$ полученная точка лежит на окружности.

<img src="pictures/01-ai.png" alt="Классическое и параметрическое представления окружности">
...
<img src="pictures/02-ai.png" alt="Три положения точки относительно окружности">
...
<img src="pictures/05-ai.png" alt="Возможные положения прямой относительно окружности">
